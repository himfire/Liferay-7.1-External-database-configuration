...
public class RegionLocalServiceWrapper
	 ...
	 */
	@Override
	public site.hadef.database2.model.Region addRegion(
	 ...
	 */
	@Override
	public site.hadef.database2.model.Region createRegion(long id) {
	 ...
	 */
	@Override
	public site.hadef.database2.model.Region deleteRegion(long id)
		throws com.liferay.portal.kernel.exception.PortalException {
	 ...
	 */
	@Override
	public site.hadef.database2.model.Region deleteRegion(
		site.hadef.database2.model.Region region) {
	...
	@Override
	public site.hadef.database2.model.Region fetchRegion(long id) {
	 ...
	 */
	@Override
	public site.hadef.database2.model.Region getRegion(long id)
		throws com.liferay.portal.kernel.exception.PortalException {
	 ...
	 */
	@Override
	public java.util.List<site.hadef.database2.model.Region> getRegions(
		int start, int end) {
	 ...
	 */
	@Override
	public site.hadef.database2.model.Region updateRegion(
		site.hadef.database2.model.Region region) {
