...
public class GenderLocalServiceWrapper
	 ...
	 */
	@Override
	public site.hadef.database3.model.Gender addGender(
	 ...
	 */
	@Override
	public site.hadef.database3.model.Gender createGender(long genderId) {
	 ...
	 */
	@Override
	public site.hadef.database3.model.Gender deleteGender(
		site.hadef.database3.model.Gender gender) {
	 ...
	 */
	@Override
	public site.hadef.database3.model.Gender deleteGender(long genderId)
	...
	@Override
	public site.hadef.database3.model.Gender fetchGender(long genderId) {
	 ...
	 */
	@Override
	public site.hadef.database3.model.Gender getGender(long genderId)
		throws com.liferay.portal.kernel.exception.PortalException {
	 ...
	 */
	@Override
	public java.util.List<site.hadef.database3.model.Gender> getGenders(
		int start, int end) {
	 ...
	 */
	@Override
	public site.hadef.database3.model.Gender updateGender(
		site.hadef.database3.model.Gender gender) {
