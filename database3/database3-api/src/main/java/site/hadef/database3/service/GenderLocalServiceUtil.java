...
package site.hadef.database3.service;
 ...
 * <code>site.hadef.database3.service.impl.GenderLocalServiceImpl</code> and
...
public class GenderLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>site.hadef.database3.service.impl.GenderLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static site.hadef.database3.model.Gender addGender(
		site.hadef.database3.model.Gender gender) {
	 ...
	 */
	public static site.hadef.database3.model.Gender createGender(
		long genderId) {
	 ...
	 */
	public static site.hadef.database3.model.Gender deleteGender(
		site.hadef.database3.model.Gender gender) {
	 ...
	 */
	public static site.hadef.database3.model.Gender deleteGender(long genderId)
	...
	public static site.hadef.database3.model.Gender fetchGender(long genderId) {
	 ...
	 * @throws PortalException if a gender with the primary key could not be found
	 */
	public static site.hadef.database3.model.Gender getGender(long genderId)
		throws com.liferay.portal.kernel.exception.PortalException {
	 ...
	 */
	public static java.util.List<site.hadef.database3.model.Gender> getGenders(
		int start, int end) {
	 ...
	 */
	public static site.hadef.database3.model.Gender updateGender(
		site.hadef.database3.model.Gender gender) {
